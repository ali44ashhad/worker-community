...
const CustomerLayout = ({ children }) => {
  ...
  return (
    <div className="relative min-h-screen bg-[var(--background-subtle)]">
      <CustomerSidebar isOpen={isDesktop ? true : isSidebarOpen} onClose={closeSidebar} />
        ...
        >
          <div className="flex items-center justify-between gap-3 px-4 py-3">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <Link to="/" className="truncate text-sm font-semibold text-[var(--text-primary)]">
                Customer
              </Link>
            </div>
