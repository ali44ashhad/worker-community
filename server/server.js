...
import localBusinessRouter from "./routes/localBusiness.route.js";
...
import { seedBusinessCategoriesIfMissing } from "./utils/seedBusinessCategories.js";
...
app.use('/api/local-businesses', localBusinessRouter);
...
async function init() {
  if (!initPromise) {
    initPromise = (async () => {
      ...
      await seedBusinessCategoriesIfMissing();
    })();
  }
  return initPromise;
}
